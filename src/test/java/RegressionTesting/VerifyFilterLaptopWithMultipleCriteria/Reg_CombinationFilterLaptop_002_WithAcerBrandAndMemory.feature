Feature: Filter LAPTOP with ACER brand and memory
  Can quickly filter a laptop list

  @RegressionTesting @CombinationFilterLaptop_002
  Scenario Outline: Filter the phone by Acer branch name and memory
