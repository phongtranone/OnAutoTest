Feature: Filter LAPTOP with MACBOOK brand and memory
  Can quickly filter a laptop list

  @RegressionTesting @CombinationFilterLaptop_007
  Scenario Outline: Filter the phone by MACBOOK branch name and memory
