Feature: Filter LAPTOP with MSI brand and memory
  Can quickly filter a laptop list

  @RegressionTesting @CombinationFilterLaptop_010
  Scenario Outline: Filter the phone by MSI branch name and memory
