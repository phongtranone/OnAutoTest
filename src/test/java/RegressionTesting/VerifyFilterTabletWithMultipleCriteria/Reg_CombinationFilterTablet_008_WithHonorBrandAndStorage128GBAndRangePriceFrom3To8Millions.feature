Feature: Filter TABLET with HONOR brand and storage and range price
  Can quickly filter a TABLET LIST

  @RegressionTesting @CombinationFilterTablet_008
  Scenario Outline: Filter the tablet by HONOR branch name and storage and range price
    ...
    Examples:
      ...
      |HONOR          |from 3 to 8 millions     |128 GB            |