Feature: Filter TABLET with OPPO brand and storage and range price
  Can quickly filter a TABLET LIST

  @RegressionTesting @CombinationFilterTablet_017
  Scenario Outline: Filter the tablet by OPPO branch name and storage and range price
    ...
    Examples:
      ...
      |OPPO         |from 3 to 8 millions   |128 GB          |